...
const Navbar = () => {
    return (
        <div id='navbar'>
            <nav className="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center ">
                <img src="./images/Screenshot 2023-08-08 at 11.40.12 AM.png"
                    style={{width:"100%"}} alt=''  />
    ...
    <p>MOVERS</p>
                ...
                <a href="/ceo-login" className="w3-bar-item w3-button w3-padding-large w3-hover-black">
    ...
    <p>CEO ONLY</p>
            ...
            <div className="w3-top w3-hide-large w3-hide-medium fixed" id="myNavbar">
              <div className="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
                  ...
                  <a href="#mover" className="w3-bar-item w3-button"
                      style={{width:"25% !important"}}>MOVERS</a>
                  <a href="#customers" className="w3-bar-item w3-button"
                      style={{width:"25% !important"}}>CUSTOMERS</a>
                  <a href="#contact" className="w3-bar-item w3-button"
                      style={{width:"25% !important"}}>CONTACT</a>
              </div>
          </div>
        </div>
    );
